 ...
 * @since 0.1.0
 */
abstract class DevHelper_Screen_Prototype {
     ...
     * <ul>
     *   <li>{@see DevHelper_Screen_Prototype::get_screen_options()}</li>
     *   <li>{@see DevHelper_Screen_Prototype::save_screen_options()}</li>
     *   <li>{@see DevHelper_Screen_Prototype::screen_options()}</li>
     * </ul>
     *
    ...
    public function screen_options( $additional_template_args = array() ) {
        ...
        ob_start( function() {} );
        include( DH_PATH . 'partials/screen_options-wizard.phtml' );
        $output = ob_get_clean();
         ...
         * @since 0.1.0
         */
        $output = apply_filters( DH_SLUG . '_screen_options_form', $output );
        echo $output;
    }

    /**
     * <p>Save screen options. Action for `admin_init` hook (see {@see DevHelper_Screen_Prototype::init} for more details). Here is an example code how to save a screen option:</p>
     * <pre>
     * $user = get_current_user_id();
     *
     * if(
    ...
    public function render( $args = array() ) {
        ...
        ob_start( function() {} );
        include( DH_PATH . 'partials/screen-' . str_replace( DH_SLUG . '-', '', $this->slug ) . '.phtml' );
        $output = ob_get_clean();
         ...
         * @since 0.1.0
         */
        $output = apply_filters( DH_SLUG . "_{$this->slug}", $output );
        echo $output;
    }
}
