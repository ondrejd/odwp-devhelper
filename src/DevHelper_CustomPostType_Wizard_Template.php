...
/**
 * Class describing template for custom post type wizard.
 * 
 * @author Ondřej Doněk, <ondrejd@gmail.com>
 * @since 0.1.0
 */
class DevHelper_CustomPostType_Wizard_Template extends DevHelper_Template_Prototype {
    ...
    public function __construct( $files = array(), $defaults = array(), $values = array() ) {
        ...
        $files = array(
            array(
                'filename' => 'class-my_custom_post_type.php',
                'filetype' => 'php',
            )
        );
